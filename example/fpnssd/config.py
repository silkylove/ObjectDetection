...
parse = argparse.ArgumentParser(description='ObjectDetection FPNSSD')
...
parse.add_argument('--ckpt_dir', default='./checkpoint_adam/')
...
handler = logging.FileHandler(log_dir + 'log_adam_1.txt')
