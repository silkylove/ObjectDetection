...
parse = argparse.ArgumentParser(description='ObjectDetection YOLOV3')

parse.add_argument('--model_params', default={"name": "darknet_53",
...
parse.add_argument('--gpuid', default='2')
